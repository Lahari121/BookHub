...
import com.android.bookhub.adapter.FavouriteRecuclerAdapter
...
class FavouritesFragment : Fragment() {
    ...
    lateinit var recyclerAdapter: FavouriteRecuclerAdapter
    ...
    override fun onCreateView(
        ...
        if(activity!=null){
            ...
            recyclerAdapter= FavouriteRecuclerAdapter(activity as Context,dbBookList)
